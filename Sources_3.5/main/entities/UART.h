...
/*
                        Aggregator::instance().addPressureData(
                            dev_name,
                            {
                                .timestamp = t,
                                .flags = flags,
                                .value = float(sensor.pressure) / 100, // to hPa
                            });
                        Aggregator::instance().addCO2Data(
                            dev_name, {
                                          .timestamp = t,
                                          .flags = flags,
                                          .value = sensor.co2,
                                      });
                        Aggregator::instance().addVOCData(
                            dev_name, {
                                          .timestamp = t,
                                          .flags = flags,
                                          .value = sensor.voc,
                                      });
                        Aggregator::instance().addIAQData(
                            dev_name, {
                                          .timestamp = t,
                                          .flags = flags,
                                          .value = sensor.iaq,
                        ...
                        ESP_LOGE(TAG,
                                 "Parsed: %.1f, %.1f, %.1f, %.1f, %.1f, %.1f",
                                 sensor.temperature, sensor.humidity,
                                 sensor.pressure, sensor.co2, sensor.voc,
                                 sensor.iaq);
*/
                    }
  ...
  public:
    ...
    void init() {
        ...
        esp_task_wdt_config_t config = {
            .timeout_ms = 10000,  // Устанавливаем тайм-аут в 10 секунд
        };
